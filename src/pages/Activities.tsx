...
const Activities = () => {
  const stats2024 = [
    { number: "1,269", label: "Navios Atendidos", icon: Ship, color: "text-primary" },
    { number: "216", label: "Navios em Clearency", icon: FileCheck, color: "text-accent" },
    { number: "20,974", label: "Tripulantes Assistidos", icon: Users, color: "text-maritime-teal" },
    { number: "100%", label: "Taxa de Satisfação", icon: TrendingUp, color: "text-maritime-gold" }
  ];

  const serviceTypes = [
    { service: "Crew Departure/Arrival", count: "458", percentage: "36%" },
    { service: "Monthly Agency Fee", count: "324", percentage: "26%" },
    { service: "Birthing Fee", count: "287", percentage: "23%" },
    { service: "Port Clearance", count: "156", percentage: "12%" },
    { service: "Outros Serviços", count: "44", percentage: "3%" }
  ];
              ...
              <Card className="card-maritime">
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground text-center mb-6">
                    ...
                    diversas necessidades do setor marítimo.
                  </p>
