...
//     shipsServed: "+0 Navios Atendidos",
//     inClearance: "+0 Navios em Clearance",
//     crewAssisted: "0 Tripulantes Assistidos",
//     yearsExperience: "0 Anos de Experiência",
//   });
...
//     const statsArray = [
//     { number: parseInt(statsHome.shipsServed.replace(/\D/g, "")), label: statsHome.shipsServed },
//     { number: parseInt(statsHome.inClearance.replace(/\D/g, "")), label: statsHome.inClearance },
//     { number: parseInt(statsHome.crewAssisted.replace(/\D/g, "")), label: statsHome.crewAssisted },
//     { number: parseInt(statsHome.yearsExperience.replace(/\D/g, "")), label: statsHome.yearsExperience },
//   ];
